...
namespace pachirapay.Connector.Model
{
    ...
    public partial class ShippingAddress :  IEquatable<ShippingAddress>
    {
        ...
        /// <param name="line1">The address line 1. (required).</param>
        /// <param name="line2">The address line 2..</param>
        /// <param name="name">The address name. (required).</param>
        /// <param name="placeCalled">The place called..</param>
        /// <param name="zipCode">The zip code. (required).</param>
        public ShippingAddress(string city = default(string), string line1 = default(string), string line2 = default(string), string name = default(string), string placeCalled = default(string), string zipCode = default(string))
        {
            ...
            if (city == null)
            {
                throw new InvalidDataException("city is a required property for ShippingAddress and cannot be null");
            }
            else
            {
                this.City = city;
            ...
            if (line1 == null)
            {
                throw new InvalidDataException("line1 is a required property for ShippingAddress and cannot be null");
            }
            else
            {
                this.Line1 = line1;
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for ShippingAddress and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (zipCode == null)
            {
                throw new InvalidDataException("zipCode is a required property for ShippingAddress and cannot be null");
            }
            else
            {
