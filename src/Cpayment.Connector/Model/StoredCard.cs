...
namespace Cpayment.Connector.Model
{
    ...
    public partial class StoredCard :  IEquatable<StoredCard>
    {
        ...
        /// Initializes a new instance of the <see cref="StoredCard" /> class.
        /// </summary>
        /// <param name="id">The stored card identifier (required).</param>
        /// <param name="label">The label for the stored card (display only).</param>
        ...
        /// </summary>
        /// <value>The stored card identifier</value>
        ...
        /// </summary>
        /// <value>The label for the stored card (display only)</value>
