...
namespace Cpayment.Connector.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CardPaymentCreditHolderRequest :  IEquatable<CardPaymentCreditHolderRequest>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CardPaymentCreditHolderRequest" /> class.
        /// </summary>
        /// <param name="merchantId">The merchant identifier.</param>
        /// <param name="merchantSiteId">The merchant site identifier.</param>
        /// <param name="currency">The currency of the order (ISO 4217).</param>
        /// <param name="country">The code of the country (ISO 3166-1 alpha-2).</param>
        /// <param name="customerRef">The customer reference.</param>
        /// <param name="creditRef">The order reference linked to the schedule and transaction.</param>
        /// <param name="creditTag">The order tag is a label for the schedule.</param>
        /// <param name="amount">The amount of the payment.</param>
        /// <param name="expirationDate">The card&#39;s expiration date.</param>
        /// <param name="cardNumber">The card number.</param>
        /// <param name="cardScheme">The card type.</param>
        public CardPaymentCreditHolderRequest(int? merchantId = default(int?), string merchantSiteId = default(string), CurrencyEnum? currency = default(CurrencyEnum?), CountryEnum? country = default(CountryEnum?), string customerRef = default(string), string creditRef = default(string), string creditTag = default(string), int? amount = default(int?), DateTime? expirationDate = default(DateTime?), string cardNumber = default(string), CardSchemeEnum? cardScheme = default(CardSchemeEnum?))
        {
        ...
        [DataMember(Name="creditTag", EmitDefaultValue=false)]
        public string CreditTag { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CardPaymentCreditHolderRequest {\n");
            ...
            sb.Append("  CreditTag: ").Append(CreditTag).Append("\n");
        ...
        {
            return this.Equals(input as CardPaymentCreditHolderRequest);
        }

        /// <summary>
        /// Returns true if CardPaymentCreditHolderRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CardPaymentCreditHolderRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CardPaymentCreditHolderRequest input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.CreditRef == input.CreditRef ||
                    (this.CreditRef != null &&
                    this.CreditRef.Equals(input.CreditRef))
                ) && 
                (
                    this.CreditTag == input.CreditTag ||
                    (this.CreditTag != null &&
                    this.CreditTag.Equals(input.CreditTag))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CreditRef != null)
                    hashCode = hashCode * 59 + this.CreditRef.GetHashCode();
                if (this.CreditTag != null)
                    hashCode = hashCode * 59 + this.CreditTag.GetHashCode();
                if (this.Amount != null)
