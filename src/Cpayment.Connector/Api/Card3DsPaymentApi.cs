...
namespace Cpayment.Connector.Api
{
    ...
    public partial class Card3DsPaymentApi : ICard3DsPaymentApi
    {
        ...
        /// <returns></returns>
        public Card3DsPaymentApi(Cpayment.Connector.Client.Configuration configuration = null)
        {
        ...
        /// <summary>
        /// Validate authentication AND authorize / payment Finish the 3DS payment.  Reuse the order references and the paymentRequestId (returned from the POST).
        /// </summary>
        /// <exception cref="Cpayment.Connector.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="authToken">Gets or sets the authentication token.</param>
        /// <param name="card3DsValidateAndAuthorizeRequest">The card payment put request. (optional)</param>
        ...
        /// <summary>
        /// Authorization / payment -with- authentication data You should pass authentication data returned by the authentication API.
        /// </summary>
        /// <exception cref="Cpayment.Connector.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="authToken">Gets or sets the authentication token.</param>
        /// <param name="card3DsAuthorizeWithAuthDataRequest">The authorize with authentication data request. (optional)</param>
