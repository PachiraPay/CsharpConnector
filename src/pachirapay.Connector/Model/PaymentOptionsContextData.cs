...
namespace pachirapay.Connector.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentOptionsContextData :  IEquatable<PaymentOptionsContextData>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentOptionsContextData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PaymentOptionsContextData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentOptionsContextData" /> class.
        /// </summary>
        ...
        public PaymentOptionsContextData(CurrencyEnum currency = default(CurrencyEnum), CountryEnum country = default(CountryEnum), long? amount = default(long?))
        {
            // to ensure "currency" is required (not null)
            if (currency == null)
            {
                throw new InvalidDataException("currency is a required property for PaymentOptionsContextData and cannot be null");
            }
            else
            {
            ...
            if (country == null)
            {
                throw new InvalidDataException("country is a required property for PaymentOptionsContextData and cannot be null");
            }
            else
            {
            ...
            if (amount == null)
            {
                throw new InvalidDataException("amount is a required property for PaymentOptionsContextData and cannot be null");
            }
            else
            {
                this.Amount = amount;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaymentOptionsContextData {\n");
        ...
        {
            return this.Equals(input as PaymentOptionsContextData);
        }

        /// <summary>
        /// Returns true if PaymentOptionsContextData instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentOptionsContextData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentOptionsContextData input)
        {
            if (input == null)
                return false;
