...
namespace pachirapay.Connector.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Card3DsCheckEnrollmentRequest :  IEquatable<Card3DsCheckEnrollmentRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Card3DsCheckEnrollmentRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected Card3DsCheckEnrollmentRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="Card3DsCheckEnrollmentRequest" /> class.
        /// </summary>
        /// <param name="returnUrl">Url for the return after the payment process (required).</param>
        ...
        public Card3DsCheckEnrollmentRequest(string returnUrl = default(string), CardPaymentContextData context = default(CardPaymentContextData), Options options = default(Options), Order order = default(Order), CardData card = default(CardData), StoredCard storedCard = default(StoredCard), ValidationModeOverride validationMode = default(ValidationModeOverride), string notificationUrl = default(string))
        {
            // to ensure "returnUrl" is required (not null)
            if (returnUrl == null)
            {
                throw new InvalidDataException("returnUrl is a required property for Card3DsCheckEnrollmentRequest and cannot be null");
            }
            else
            {
            ...
            if (context == null)
            {
                throw new InvalidDataException("context is a required property for Card3DsCheckEnrollmentRequest and cannot be null");
            }
            else
            {
            ...
            if (order == null)
            {
                throw new InvalidDataException("order is a required property for Card3DsCheckEnrollmentRequest and cannot be null");
            }
            else
            {
                this.Order = order;
        ...
        /// </summary>
        /// <value>Url for the return after the payment process</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Card3DsCheckEnrollmentRequest {\n");
        ...
        {
            return this.Equals(input as Card3DsCheckEnrollmentRequest);
        }

        /// <summary>
        /// Returns true if Card3DsCheckEnrollmentRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of Card3DsCheckEnrollmentRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Card3DsCheckEnrollmentRequest input)
        {
            if (input == null)
                return false;
